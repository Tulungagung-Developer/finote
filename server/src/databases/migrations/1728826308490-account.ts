...
export class Account1728826308490 implements MigrationInterface {
  name = 'Account1728826308490';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "account" ("id" uuid NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "user_id" uuid NOT NULL, "type" character varying NOT NULL, "currency" character varying NOT NULL, "name" character varying(100) NOT NULL, "reference" character varying(50), "balance" numeric(10,2) NOT NULL, "minimum_balance" numeric(10,2) NOT NULL, "version" integer NOT NULL, CONSTRAINT "PK_54115ee388cdb6d86bb4bf5b2ea" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(`CREATE INDEX "IDX_414d4052f22837655ff312168c" ON "account" ("name") `);
    await queryRunner.query(
      `CREATE TABLE "account_history" ("id" uuid NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "account_id" uuid NOT NULL, "action" character varying NOT NULL, "description" character varying NOT NULL, "pre_balance" numeric(10,2) NOT NULL, "post_balance" numeric(10,2) NOT NULL, CONSTRAINT "PK_de0652296aa9d641c6269104b98" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(`CREATE INDEX "IDX_c2f121740ab4e268b11c677bd1" ON "account_history" ("action") `);
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`DROP INDEX "public"."IDX_c2f121740ab4e268b11c677bd1"`);
